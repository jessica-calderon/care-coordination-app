        ...
        <div className="space-y-8 text-base leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="mt-8 p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
              <strong style={{ color: 'var(--text-secondary)' }}>Note:</strong> Your data is securely stored in Firebase and automatically syncs across all devices where you access your care notebook. No accounts are required—access is controlled through your notebook link.
            </p>
          </div>
        </div>
      </section>
